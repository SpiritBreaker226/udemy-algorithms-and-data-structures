...
describe('sorting', () => {
  ...
  describe('for merge sort', () => {
    ...
    it('should return a sorted large array', () => {
      expect(mergeSort([100, 50, 82, 69, 25, 77, 99, 32, 75, 45, 10])).toEqual([
        10,
        25,
        32,
        45,
  ...
  describe('for quick sort', () => {
    ...
    it('should return a sorted large array', () => {
      expect(quickSort([100, 50, 82, 69, 25, 77, 99, 32, 75, 45, 10])).toEqual([
        10,
        25,
        32,
        45,
  ...
  describe('for radix sort', () => {
    ...
    it('should return a sorted large array', () => {
      expect(radixSort([100, 50, 82, 69, 25, 77, 99, 32, 75, 45, 10])).toEqual([
        10,
        25,
        32,
        45,
